...
\end{minipage}
   ...
   {\bf КУРСОВАЯ РАБОТА\\
    по направлению  \\
		...
		%\vspace{1em}
		профиль\\
		«Прикладная информатика~(Разработка программного обеспечения)»\\}
    \end{center}
		
		%\vspace{2.5em}%вертикальное расстояние
    \begin{center}
  		Приложение для визуального конструирования нейронных сетей\\
    \end{center}
...
\begin{minipage}[t]{0.5\textwidth}
  ...
  группа 14321\\
        \rule{1,8cm}{0,1pt} Г. А. Воловиков\\
	\vspace{2em}
		
	Руководитель: ст.преподаватель\\
            \rule{1,8cm}{0,1pt} А. В. Кисилёв\\
\vspace{2em}
 Работа защищена:\\
